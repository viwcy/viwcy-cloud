package com.viwcy.searchserver.service;
...
public class RocketMQConsumeListenerProcessor implements MessageListenerConcurrently {
    ...
    public ConsumeConcurrentlyStatus consumeMessage(List<MessageExt> messageExtList, ConsumeConcurrentlyContext context) {
        ...
        log.info("RocketMQ接收到消息：{}，topic = [{}]，tag = [{}]", message, messageExt.getTopic(), messageExt.getTags());
        ...
        //TODO 策略模式处理对应的业务逻辑，不能捕获异常，因为execute方法可能会有事务操作
        abstractBeanFactory.topic(messageExt.getTopic() + "@" + messageExt.getTags()).execute(message);
        //TODO 存储消息表，做幂等性处理
        //...
